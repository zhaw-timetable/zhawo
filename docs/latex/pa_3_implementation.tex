...
We put alot of time and effort into the design. We wanted to ensure that we leave a great first impression.
...
The first User test were very positive, but we learned that most Users disliked the dark theme. So we changed the default theme and left the option for users to change to the dark theme if prefered.
