...
<Notes>Agile approach with sprints of 2 weeks</Notes>
...
<Notes>For actual sprint planning used GitHub project board</Notes>
...
<Notes>Travis CI to keep track of build status</Notes>
